...
export default function WatchMyLocationScreen({route}) {
  Geocoder.init('AIzaSyDLuSEtxXzOHHRsmHCKCk_EyJHGncgfa-k', {language: 'ko'});
  const myLocation = route.params.data;
    ...
    <>
      <SafeAreaView style={{height: '100%', backgroundColor: 'white'}}>
        <View style={styles.distanceInfo}>
          <Text style={styles.distanceText}>현재 위치를 확인하세요</Text>
        </View>
...
const styles = StyleSheet.create({
  distanceText: {color: Colors.MAIN_COLOR, fontSize: 20},
